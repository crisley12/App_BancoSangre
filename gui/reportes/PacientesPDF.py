...
class PDF(FPDF):
    # Cabecera de página
    def header(self):
        #self.image('asset/img/LogoPDF.jpg', 10, 10, 70)
        self.set_xy(150, 10)
...
pdf.cell(10, 15, "Pacientes", 0, 0, 'L')
pdf.ln(2)
...
for paciente in pacientes:
    nombre = paciente['p_nombre'] + ' ' + paciente['s_nombre']
    apellido = paciente['p_apellido'] + ' ' + paciente['s_apellido']
